...
class ChargerStateMachine:
    def __init__(self, sense, duration, component):
    ...
    def create_machine(component):
        charger_logic = ChargerStateMachine(
            component=component
        )
        t0 = {"source": "initial", "target": "idle"}
        t1 = {"source": "idle", "target": "reserved", "trigger" : "reserve15", "effect": "start_15"}
        t2 = {"source": "idle", "target": "reserved", "trigger" : "reserve30", "effect": "start_30"}
        t3 = {"source": "reserved", "target": "charging", "trigger" : "button_press", "effect": "start_charging"}
        t4 = {"source": "idle", "target": "awaiting", "trigger" : "start_charge", "effect": "start_1"}
        t5 = {"source": "awaiting", "target": "charging", "trigger" : "button_press", "effect": "start_charging"}
        t6 = {"source": "reserved", "target": "idle", "trigger" : "t15"}
        t7 = {"source": "reserved", "target": "idle", "trigger" : "t30"}
        t8 = {"source": "awaiting", "target": "idle", "trigger" : "t1"}
        t9 = {"source": "charging", "target": "idle", "trigger" : "button_press"}


        charger_stm = stmpy.Machine(name="charger", transitions=[t0, t1, t2, t3, t4, t5, t6, t7, t8, t9], obj=charger_logic)
